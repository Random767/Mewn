...
module.exports = {
    ...
    async execute(interaction, client) {
        ...
        let online = servidor.members.cache.filter(x => x.presence.status === 'online').size
        let idle = servidor.members.cache.filter(x => x.presence.status === 'idle').size
        let dnd = servidor.members.cache.filter(x => x.presence.status === 'dnd').size
